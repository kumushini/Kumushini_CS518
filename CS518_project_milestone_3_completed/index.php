...
if(isset($_GET['searchterm'])){
    ...
    //header("location:src/search_.php");
    header("location:src/pagination_index.php");
   
    // $q = $_GET['q'];

    if (empty($searchterm)){
        // header('Location:./index.php?error=Please enter a keyword to search');
        echo('please enter a search term to search');
        exit();
    }
}
?>
...
<head>
    ...
    <title>Archiveia Digital Library</title>
...
<body>
    ...
    <div class="jumbotron" style="height:750px">
        ...
        <div class="container warapper">
            <form class="input-group input-group-lg" action="index.php" method="get" autocomplete="off">
 ...
 <footer class="bg-body-tertiary text-center text-lg-start" style="position:fixed; width:100%; bottom:0;">
  <!-- Copyright -->
